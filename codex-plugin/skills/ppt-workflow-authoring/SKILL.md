...
4. Maintain deliberate page rhythm, layout variation, readable CJK/Latin typography, and a source review at native size. Repair clipping, overflow, overlap, blank render, untraceable data, or a layout/material mismatch before conversion.
